...
export const roomApi = {
  ...
  // `participants` and `departments` are omitted for anonymous callers — a room
  // code alone must not disclose who is in the room. Pass a signed-in user's
  // token to receive them.
